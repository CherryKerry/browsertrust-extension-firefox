...
/**
 * Displays the fingerprint for the current page
 */
BrowserTrust.Fingerprint = 
{
  fingerprintCurrentPage : function(aEvent) 
  {
  	var markup = document.documentElement.innerHTML;
    var hashSha256 = generateFingerPrint(markup, false)
 	window.alert(hashSha256);
  }
};
 ...
 */
function generateFingerPrint(msg, utf8encode) 
{
